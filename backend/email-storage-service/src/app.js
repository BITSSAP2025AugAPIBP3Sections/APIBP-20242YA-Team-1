...
import {jwtAuth, decodeForHealth} from "./middleware/jwtAuth.js";
...
app.get("/health", (req, res) => {
   res.json({status:"OK", service: "email-storage-service", auth: decodeForHealth(req.headers.authorization)});
});
